package com.alclabs.deslizareliminarrecyclerview.CallBacks;
...
public class MyItemTouchHelperCallback extends ItemTouchHelper.Callback {
    ...
    public void onChildDraw(@NonNull Canvas c, @NonNull RecyclerView recyclerView, @NonNull RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive) {
       if(actionState== ItemTouchHelper.ACTION_STATE_DRAG){
           ...
           final View foregroundView = ((RecyclerViewPersonasAdapter.ViewHolder)viewHolder).viewB;
           getDefaultUIUtil().onDrawOver(c, recyclerView,
                   foregroundView, dX, dY, actionState, isCurrentlyActive);
       }
    }
    ...
    public void onChildDrawOver(@NonNull Canvas c, @NonNull RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive) {
        if(actionState!=ItemTouchHelper.ACTION_STATE_DRAG){
            final View foregroundView = ((RecyclerViewPersonasAdapter.ViewHolder)viewHolder).viewF;
    ...
    public void clearView(@NonNull RecyclerView recyclerView, @NonNull RecyclerView.ViewHolder viewHolder) {
        ...
        foregroundView.setBackgroundColor(ContextCompat.getColor(((
                RecyclerViewPersonasAdapter.ViewHolder
